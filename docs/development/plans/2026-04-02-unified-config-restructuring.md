...
**Goal:** Update all remaining YAML configuration files in `config/` and `deploy/docker-singletenant/` to the new Unified Peer Model structure.
...
- Modify: `deploy/docker-singletenant/gate-demo.yaml`
...
- [ ] **Step 4: Update `deploy/docker-singletenant/gate-demo.yaml`**
...
- Modify: `deploy/docker-singletenant/keep-demo.yaml`
...
- [ ] **Step 4: Update `deploy/docker-singletenant/keep-demo.yaml`**

### Task 3: Update Portcullis-Guard Configurations

**Files:**
- Modify: `config/guard-config.minimal.yaml`
- Modify: `deploy/docker-singletenant/guard-demo.yaml`

- [ ] **Step 1: Update `config/guard-config.minimal.yaml`**
- [ ] **Step 2: Update `deploy/docker-singletenant/guard-demo.yaml`**
